...
export default function AboutUs() {
  ...
  return (
    <div className="bg-white text-gray-900">
      ...
      {/* HERO */}
      <section className="relative bg-gradient-to-br from-gray-900 via-blue-900 to-blue-800 text-white text-center px-6 py-20">
        ...
        <div className="max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {teamMembers.map((member) => (
            <div
              ...
              onClick={() =>
                setActiveTeam(
                  activeTeam === member.name ? null : member.name
                )
              }
